...
- Komplex típusok megnevezés nélküli unionja szigorúan tilos. type Union = {type: 'A', ...} | {type: 'B', ...} SZIGORÚAN tilos. Minden union alternatívának értelmes névvel saját típusnak kell lennie. type A = {type: 'A', ...} type B = {type: 'B', ...} type Union = A | B.
