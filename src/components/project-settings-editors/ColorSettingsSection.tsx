...
export const ColorSettingsSection: FC<ProjectComponentSettingsSectionProps> = ({ editable, issues, onChange }) => {
  ...
  return (
    <SectionGroup.Section>
      <SectionGroup.SectionHeader>{t.projects.settingsDialog.colorSettings.title}</SectionGroup.SectionHeader>
      ...
      <SectionGroup.SectionRowTitle>{t.projects.settingsDialog.colorSettings.strokeColor}</SectionGroup.SectionRowTitle>
