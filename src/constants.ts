...
export const LANDSCAPE_ISO_CARD_SIZE: SizeSchema = {
  width: ISO_CARD_WIDTH,
  height: ISO_CARD_HEIGHT,
}

export const PORTRAIT_ISO_CARD_SIZE: SizeSchema = {
  width: ISO_CARD_HEIGHT,
  height: ISO_CARD_WIDTH,
}

export const ISO_CARD_SIZE_BY_ORIENTATION: Record<CardOrientation, SizeSchema> = {
