...
import type { StitchCornerSchema, StitchLineCommonConfigSchema } from '../stitching'
import { ComputedSubProjectSchema, SubProjectSchema } from '../subProject'
import { MagicFixSettingsSchema } from './magicFixSettings3'
...
export type MagicFixSharpCornerStitchHoleDistanceIssueSchema = HasId & {
...
export type MagicFixClosedRouteStitchHoleDistanceIssueSchema = HasId & {
...
export type MagicFixRouteEndpointMissingStitchHoleIssueSchema = HasId & {
...
export type MagicFixEndpointMinimumEdgeDistanceIssueSchema = HasId & {
...
export type MagicFixEdgeCrossingMinimumStitchHoleDistanceIssueSchema = HasId & {
...
export type MagicFixIssueDetectorInput = {
  ...
  magicFixSettings: MagicFixSettingsSchema
  stitchLineSettings: StitchLineCommonConfigSchema
  stitchLineId: string
}
