...
export const validateRectHoleSchema = (
  input: EditableSchema<RectHoleSchema>,
  currentValue: RectHoleSchema,
  context: ComponentBasedValidationContextSchema,
): ValidationResultSchema<RectHoleSchema> => {
  ...
  const issues: ValidationIssuesSchema<RectHoleSchema> = {
  ...
  const committedValue: RectHoleSchema = {
