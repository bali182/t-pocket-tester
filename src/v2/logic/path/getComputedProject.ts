...
} from '../../schemas/computed2'
import type { RectSchema } from '../../schemas/geometry'
import type { ComputedProjectSchema2, ProjectSchema } from '../../schemas/project'
...
export const getComputedProject = (project: ProjectSchema): ComputedProjectSchema2 => {
