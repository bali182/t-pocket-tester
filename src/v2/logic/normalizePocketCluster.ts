...
export const normalizePocketCluster = (
  ...
  const pocketStep = clamp(pocketCluster.pocketStep, 0, stackLength / Math.max(tPocketCount, 1))
  ...
  return {
    ...
    pocketCount,
    pocketStep,
    tPocketTabWidth: clamp(pocketCluster.tPocketTabWidth, 0, halfCrossSize),
    tPocketTaper: clamp(pocketCluster.tPocketTaper, 0, halfCrossSize),
  }
}
